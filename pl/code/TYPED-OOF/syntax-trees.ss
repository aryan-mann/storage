...
;;; for abstract syntax trees of the TYPED-OOF programming language,
...
(define-library (TYPED-OOF syntax-trees)
  (export program? a-program
          ...
          instanceof-exp fieldref-exp fieldset-exp
          abstract-method-declaration? an-abstract-method-declaration)          
  (import (scheme base)
          (utilities eopl))
  (begin

    ;; Like CLASSES, TYPED-OOF allows multiple bindings to be introduced
    ...
    ;; The grammar for TYPED-OOF is as follows:
    ;;
    ...
    (define-datatype expression expression?
      ...
      ;; [Aryan]
      (fieldref-exp (exp expression?)
                    (id identifier?))
      (fieldset-exp (exp expression?)
                    (id identifier?)
