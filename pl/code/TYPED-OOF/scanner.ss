...
;;; A scanner for the TYPED-OOF language
...
(define-library (TYPED-OOF scanner)
  (export scanner)
  (import (scheme base)
          (scheme char)
          (utilities eopl)
  ...
  ;; Comments in the TYPED-OOF language
              ...
              ((char-alphabetic? next)
               (let ((id (get-identifier source)))
                 (case id
                   ...
                   ((int) (int-token))
                   ((bool) (bool-token))
                   ((implements) (implements-token))
                   ((interface) (interface-token))
                   ((cast) (cast-token))
                   ((instanceof) (instanceof-token))
                   ((void) (void-token))

                   ;; [Aryan]
                   ((fieldref) (fieldref-token))
                   ((fieldset) (fieldset-token))
