...
;;; for lexical tokens of the TYPED-OOF programming language,
...
;;; TYPED-OOF has tokens of forty-six kinds:
...
(define-library (TYPED-OOF tokens)
  (export token? numeral-token minus-sign open-parenthesis comma
          ...
          instanceof-token void-token listof-token fieldset-token fieldref-token underscore)
  (import (scheme base)
          (utilities eopl))
  (begin
