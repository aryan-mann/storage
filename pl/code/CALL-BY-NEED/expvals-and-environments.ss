...
;;; Expressed values and environments for CALL-BY-NEED
...
;;; for expressed values of the CALL-BY-NEED programming language,
...
(define-library (CALL-BY-NEED expvals-and-environments)
  ...
  (begin
    ...
    ;; An expressed value in CALL-BY-NEED
    ...
    ;; In CALL-BY-NEED, a thunk can be stored in a reference
    ...
    ;; CALL-BY-NEED programs are evaluated
