...
;;; A scanner for the MUTABLE-PAIRS language
...
;;; for the MUTABLE-PAIRS language
...
(define-library (MUTABLE-PAIRS scanner)
  (export scanner)
  (import (scheme base)
          (scheme char)
          (utilities eopl)
  ...
  ;; Comments in the MUTABLE-PAIRS language
              ...
              ((char-alphabetic? next)
               (let ((id (get-identifier source)))
                 (case id
                   ...
                   ((left) (left-token))
                   ((right) (right-token))
                   ((setleft) (setleft-token))
                   ((setright) (setright-token))
