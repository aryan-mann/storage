...
;;; Stores and references for MUTABLE-PAIRS
...
;;; in the MUTABLE-PAIRS programming language,
...
(define-library (MUTABLE-PAIRS stores)
  ...
  (begin
    ...
    ;; Every variable in MUTABLE-PAIRS denotes a storage location,
