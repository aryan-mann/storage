...
;;; for lexical tokens of the IMPLICIT-REFS programming language,
...
;;; IMPLICIT-REFS has tokens of nineteen kinds:
...
(define-library (IMPLICIT-REFS tokens)
