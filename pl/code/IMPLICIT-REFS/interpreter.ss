...
;;; An interpreter for the IMPLICIT-REFS language

;;; John David Stone
;;; Department of Computer Science
;;; Grinnell College

;;; This is an interpreter for the IMPLICIT-REFS programming language,
...
(define-library (IMPLICIT-REFS interpreter)
  (export run)
  (import (scheme base)
          (utilities eopl)
          (IMPLICIT-REFS parser)
          (IMPLICIT-REFS stores)
          (IMPLICIT-REFS expvals-and-environments))
  (begin
