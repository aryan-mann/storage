...
;;; Expressed values and environments for IMPLICIT-REFS
...
;;; for expressed values of the IMPLICIT-REFS programming language,
...
(define-library (IMPLICIT-REFS expvals-and-environments)
  ...
  (import (scheme base)
          ...
          (IMPLICIT-REFS stores))
  (begin

    ;; An expressed value in IMPLICIT-REFS
    ...
    ;; IMPLICIT-REFS programs are evaluated
