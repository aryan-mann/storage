...
;;; Stores and references for IMPLICIT-REFS
...
;;; in the IMPLICIT-REFS programming language,
...
(define-library (IMPLICIT-REFS stores)
  ...
  (begin
    ...
    ;; Every variable in IMPLICIT-REFS denotes a storage location,
