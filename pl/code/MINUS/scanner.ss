...
;;; A scanner for the MINUS language

;;; John David Stone and Aryan Mann
...
;;; for the MINUS language,

(define-library (MINUS scanner)
  (export scanner)
  (import (scheme base)
          (scheme char)
          (utilities eopl)
  ...
  ;; Comments in the MINUS language
...
;;; Copyright (C) 2009, 2015, 2019  John David Stone and Aryan Mann
