...
;;; A scanner for the CHECKED language
...
(define-library (CHECKED scanner)
  (export scanner)
  (import (scheme base)
          (scheme char)
          (utilities eopl)
  ...
  ;; Comments in the CHECKED language
  ...
  ;; the beginning of a numeral,
  ;; or the beginning of an arrow,
