...
;;; A scanner for the LETREC-LCPI language
...
(define-library (LETREC-LCPI scanner)
  (export scanner)
  (import (scheme base)
          (scheme char)
          (utilities eopl)
  ...
  ;; Comments in the LETREC-LCPI language
