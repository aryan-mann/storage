...
;;; A scanner for the CALL-BY-REFERENCE, CALL-BY-NAME, and CALL-BY-NEED languages
...
;;; for the CALL-BY-REFERENCE, CALL-BY-NAME, and CALL-BY-NEED languages
;;; developed by Daniel P. Friedman and Mitchell Wand
;;; in section 4.5 of their book
;;; _Essentials of programming languages_ (third edition).

(define-library (CALL scanner)
  (export scanner)
  (import (scheme base)
          (scheme char)
          (utilities eopl)
  ...
  ;; Comments in the CALL-BY-REFERENCE language
