...
;;; Tokens in CALL-BY-REFERENCE, CALL-BY-NAME, and CALL-BY-NEED
...
;;; This library defines a data type for lexical tokens
...
;;; These languages have tokens of nineteen kinds:
...
(define-library (CALL tokens)
  (export token? numeral-token minus-sign open-parenthesis comma
          ...
          set-token begin-token semicolon end-token)
  (import (scheme base)
          (utilities eopl))
  (begin
